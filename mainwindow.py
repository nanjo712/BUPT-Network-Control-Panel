...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(514, 184)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(parent=self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 491, 151))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(200, 10, 361, 101))
...
"font-color:white;")
        ...
        self.checkBox_5 = QtWidgets.QCheckBox(parent=self.SettingTab)
        self.checkBox_5.setGeometry(QtCore.QRect(400, 20, 81, 31))
        self.checkBox_5.setObjectName("checkBox_5")
        self.label_5 = QtWidgets.QLabel(parent=self.SettingTab)
        self.label_5.setGeometry(QtCore.QRect(310, 50, 61, 31))
        ...
        self.checkBox_6 = QtWidgets.QCheckBox(parent=self.SettingTab)
        self.checkBox_6.setGeometry(QtCore.QRect(400, 50, 81, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_5.setText(_translate("MainWindow", "未启用"))
        self.label_5.setText(_translate("MainWindow", "邮件设置"))
        self.label_6.setText(_translate("MainWindow", "WiFi账号设置"))
        self.checkBox_6.setText(_translate("MainWindow", "未启用"))
